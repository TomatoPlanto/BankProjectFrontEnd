<template>
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div style="height:2px; background:linear-gradient(90deg,var(--accent),transparent); margin-bottom:1.75rem; border-radius:2px;"></div>

      <div v-if="error" class="alert alert-error">⚠ {{ error }}</div>

      <form @submit.prevent="handleAtmLogin">
        <div class="field">
