        ...
        <div class="grid">
            ...
            <section class="panel">
              ...
              <div class="chart-wrap">
                <svg class="chart-svg" viewBox="0 0 560 140" preserveAspectRatio="none">
                  ...
                  <!-- Grid lines -->
                  <line x1="0" y1="35"  x2="560" y2="35"  stroke="rgba(26,34,48,0.06)" stroke-width="1"/>
                  <line x1="0" y1="70"  x2="560" y2="70"  stroke="rgba(26,34,48,0.06)" stroke-width="1"/>
                  <line x1="0" y1="105" x2="560" y2="105" stroke="rgba(26,34,48,0.06)" stroke-width="1"/>
                  <!-- Filled area -->
          ...
          <div class="col">
            ...
            <section class="panel">
              ...
              <div class="actions">
                <template v-if="authStore.isEmployee">
                  <RouterLink to="/accounts" class="action" style="text-decoration:none">
                    <div class="action-ico">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="6" width="18" height="13" rx="2"/><path d="M3 10h18"/></svg>
                    </div>
                    <span>Accounts</span>
                  </RouterLink>
                  <RouterLink to="/users" class="action" style="text-decoration:none">
                    <div class="action-ico">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4"/><path d="M5 21c0-3.5 3-6 7-6s7 2.5 7 6"/></svg>
                    </div>
                    <span>Users</span>
...
// Monthly activity volumes — derived from seeded transaction amounts per month
...
const chartLinePath = computed(() => {
  ...
  return chartPts.value.reduce((d, p, i) => {
