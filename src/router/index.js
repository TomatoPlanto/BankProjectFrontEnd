...
import TransactionPage from '../components/pages/TransactionPage/TransactionPage.vue'
...
const routes = [
  ...
  { path: '/transaction/:transactionId', name: 'transaction', component: TransactionPage,  meta: { requiresAuth: true, employeeOnly: false } },
